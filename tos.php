...
<head>
<meta charset="utf-8"/>
<title>For Movers Only - Terms of Service</title>
...
<body style="background-color: #444!important">
<div class="container">
	<div class="row">
	...
	<div class="row">
		<div class="col-md-12 coming-soon-content">
            ...
            <h4 class="text-danger">Permitted and Prohibited Uses</h4>
            <p>
            ...
            <h4 class="text-danger">User Submissions</h4>
            <p>
            ...
            <h4 class="text-danger">User Discussion Lists and Forums</h4>
            <p>
            ...
            <h4 class="text-danger">Use of Personally Identifiable Information</h4>
            <p>
            ...
            <h4 class="text-danger">Indemnification</h4>
            <p>
            ...
            <h4 class="text-danger">Termination</h4>
            <p>
            ...
            <h4 class="text-danger">Warrenty Disclaimer</h4>
            <p>
            ...
            <h4 class="text-danger">Links to Other Materials</h4>
            <p>
            ...
            <h4 class="text-danger">Notification Of Possible Copyright Infringement</h4>
            <p>
                In the event you believe that material or content published on the Website may infringe on your copyright or that of another, please <abbr title="Contact Us" data-original-title="Contact Us">Contact Us</abbr>.
            </p> <br/>
		</div>
	</div>
	<!--/end row-->
