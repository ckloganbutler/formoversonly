...
if(isset($_SESSION['logged'])){
    ...
    ?>
    <div class="page-content" <?php if(empty($_GET['luid'])){echo "style='margin-left: 0px!important;'";} ?>>
        <h3 class="page-title">
            <strong>Welcome!</strong><small> &nbsp; Please create your first location to get started with the software.</small>
        </h3>
        <div class="page-bar">
                                    ...
                                    submitHandler: function(form) {
                                        $.ajax({
                                            ...
                                            success: function(data) {
                                                ...
                                                location.replace("//www.formoversonly.com/dashboard/?x=a&luid=" + data);
                                            },
                                            error: function() {
