    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a class="load_page" data-href="assets/pages/inventory.php?luid=<?php echo $_GET['luid']; ?>" data-page-title="Inventory">Inventory</a>
                </li>
            </ul>
        </div>
        <div class="row">
                ...
                <div class="portlet light">
                    <div class="portlet-title tabbable-line">
                        <div class="caption caption-md">
                            <i class="icon-eye theme-font bold"></i>
                            <span class="caption-subject font-red bold uppercase"><?php echo $location['location_name']; ?></span> <span class="font-red">|</span>  <small>Inventory</small>
                        </div>
