...
if(isset($_SESSION['uuid'])){
    ...
    while($vendor = mysql_fetch_assoc($findVendors)) {
        ...
        $records["data"][] = array(
            ...
            '<a class="editable_item_'.$vendor['vendor_id'].'" style="color:#333333" data-name="vendor_type" data-pk="'.$vendor['vendor_id'].'" data-type="select" data-placement="right" data-title="Select new vendor type.." data-url="assets/app/update_settings.php?update=location_vendor">'.$vendor['vendor_type'].'</a>',
            '<a class="editable_item_'.$vendor['vendor_id'].'" style="color:#333333" data-name="vendor_phone" data-pk="'.$vendor['vendor_id'].'" data-type="number" data-placement="right" data-title="Enter new vendor phone.." data-url="assets/app/update_settings.php?update=location_vendor">'.$vendor['vendor_phone'].'</a>',
            '<a class="editable_item_'.$vendor['vendor_id'].'" style="color:#333333" data-name="vendor_contact" data-pk="'.$vendor['vendor_id'].'" data-type="number" data-placement="right" data-title="Enter new vendor contact.." data-url="assets/app/update_settings.php?update=location_vendor">'.$vendor['vendor_contact'].'</a>',
            '<a class="editable_item_'.$vendor['vendor_id'].'" style="color:#333333" data-name="vendor_account_ref" data-pk="'.$vendor['vendor_id'].'" data-type="select" data-placement="right" data-title="Enter new account #.." data-url="assets/app/update_settings.php?update=location_vendor">'.$vendor['vendor_account_ref'].'</a>',
            '<a class="editable_item_'.$vendor['vendor_id'].'" style="color:#333333" data-name="vendor_extra_ref" data-pk="'.$vendor['vendor_id'].'" data-type="select" data-placement="right" data-title="Enter new extra reference.." data-url="assets/app/update_settings.php?update=location_vendor">'.$vendor['vendor_extra_ref'].'</a>',
