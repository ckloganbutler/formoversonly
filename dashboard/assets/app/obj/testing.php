...
$uuid   = "1234AXCVBB";
$cuid   = "123ACV";
$email  = "loganck@outlyehosting.com";

$subject = "Welcome to For Movers Only, $fname.";

$headers = "From: Registration <registration@formoversonly.com>\r\n";
$headers .= "Reply-To: Registration <registration@formoversonly.com>\r\n"; // Return path for errors
...
<head>
  ...
  <title>Welcome to For Movers Only, {$fname}.</title>
  <style type="text/css">
              ...
              <tr>
                <td valign="top" class="mobile-block mobile-no-padding-bottom mobile-center" width="270" style="background:#1f1f1f;padding:10px 10px 10px 20px;">
                  <a href="#" style="text-decoration:none;">
                    <img src="https://www.formoversonly.com/dashboard/assets/admin/layout/img/logo-big.png" width="142" height="30" alt="Your Logo"/>
                  </a>
                </td>
              </tr>
            </table>
            ...
            <table cellpadding="0" cellspacing="0" width="600" class="w320">
              <tr>
                <td align="left" class="mobile-padding" style="padding:20px 20px 0">
                  ...
                  <br>
                  We're excited to have you with us! Please click the link below to activate your account and begin using Eddie, our latest fleet management software.<br>
                  <br>
...
$email = "Thanks for registering on For Movers Only! <br /> <br />";
$email .= "Please click the following link to validate your account, $fname. <br />";
$email .= "<a href='http://www.formoversonly.com/dashboard/assets/app/validate.php?uuid=$uuid&cuid=$cuid'>Verify my account!</a>";
$email .= "<br /> <br />Once you've verified your account, you'll have access to everything For Movers Only has to offer. Including the various <strong>FREE</strong> tools that allow you to seamlessly manage your fleets.";
$email .= "<br /> <br />&copy; 2016 For Movers Only";
