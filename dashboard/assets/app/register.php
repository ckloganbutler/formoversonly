...
if(isset($_POST) && !isset($_GET['disabled'])){
    ...
    if($checkTaken == 0){
        mysql_query("INSERT INTO fmo_users (user_group, user_token, user_company_token, user_employer, user_employer_location,  user_fname, user_mname, user_lname, user_email, user_phone, user_pword, user_address, user_address2, user_apt, user_city, user_state, user_zip, user_company_name, user_creator, user_pic, user_last_ext_location, user_creator_user, user_license_exp) VALUES (
        ...
        '".mysql_real_escape_string(date('Y-m-d G:i:s', strtotime("today + 90 days")))."')");
